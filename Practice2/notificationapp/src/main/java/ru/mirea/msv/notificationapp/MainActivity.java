package ru.mirea.msv.notificationapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickNewMessageNotification(View view){
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel notificationChannel = new NotificationChannel(CHANNEL_ID, "My N" +
                    "otifications", NotificationManager.IMPORTANCE_DEFAULT);
